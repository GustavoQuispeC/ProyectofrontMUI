...
export default function RegistrarEmpleado() {
    ...
    const onSubmit = async (data: EmpleadoForm) => {
        ...
        try {
            ...
            await toastPromise(
                registrarEmpleadoMutation.mutateAsync(payload),
                {
            ...
            // Si la imagen ya se subió pero el registro falló,
            // eliminar la imagen para evitar archivos huérfanos.
            if (storagePath) {
            ...
            <Section icon={<AccountBalanceIcon/>} title="Financiero y Seguros">
                ...
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                        ...
                        control={control}
                        render={({field}) =>
                            <InputCard {...field} value={field.value ?? ""} label="Cuenta Sueldo"/>}
                    />
                </Grid>
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                        ...
                        control={control}
                        render={({field}) =>
                            <InputCard {...field} value={field.value ?? ""} label="CCI Sueldo"/>}
                    />
                </Grid>
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                ...
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                        ...
                        control={control}
                        render={({field}) =>
                            <InputCard {...field} value={field.value ?? ""} label="Cuenta CTS"/>}
                    />
                </Grid>
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                        ...
                        control={control}
                        render={({field}) =>
                            <InputCard {...field} value={field.value ?? ""} label="CCI CTS"/>}
                    />
                </Grid>
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                ...
                <Grid size={{xs: 12, sm: 6, md: 4}}>
                    <Controller
                        ...
                        control={control}
                        render={({field}) =>
                            <InputCard {...field} value={field.value ?? ""} label="CUSPP"/>}
                    />
                </Grid>
            </Section>
