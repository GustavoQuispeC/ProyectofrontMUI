      ...
      <Section icon={<AccountBalanceIcon />} title="Financiero y Seguros">
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
            name="cuentaSueldo"
            control={control}
            render={({ field }) => <InputCard {...field} value={field.value ?? ""} label="Cuenta Sueldo" />}
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
            name="cciSueldo"
            control={control}
            render={({ field }) => <InputCard {...field} value={field.value ?? ""} label="CCI Sueldo" />}
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
            name="cuentaCTS"
            control={control}
            render={({ field }) => <InputCard {...field} value={field.value ?? ""} label="Cuenta CTS" />}
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
            name="cciCTS"
            control={control}
            render={({ field }) => <InputCard {...field} value={field.value ?? ""} label="CCI CTS" />}
          />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Controller
