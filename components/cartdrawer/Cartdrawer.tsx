  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-[18px] border-b border-black/5 dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl border border-black/5 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center justify-center">
              <ShoppingCart className="w-[18px] h-[18px] text-slate-700 dark:text-white/80" />
            </div>
            <div>
              <p className="text-[15px] font-medium text-slate-900 dark:text-white flex items-center gap-2">
                Tu carrito
                <span className="inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-[11px] font-medium">
                  {badgeQty}
                </span>
              </p>
